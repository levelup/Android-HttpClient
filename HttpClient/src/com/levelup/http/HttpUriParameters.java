...
/**
 * HTTP parameters suitable to pass to {@link com.levelup.http.BaseHttpRequest.AbstractBuilder#setUrl(String, HttpUriParameters) BaseHttpRequest.Builder.setUrl()}
 */
